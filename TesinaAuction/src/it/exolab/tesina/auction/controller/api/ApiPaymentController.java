...
import it.exolab.tesina.auction.service.api.PaymentService;
...
//	@Autowired(required = true)
//	public void setPaymentService(AuctionOrderService  auctionOrderService, AuctionService auctionService, 
...
//	}
	...
	public void doPaymentNotify(@ModelAttribute ReturnPayment returnPayment) {
		...
		paymentService.paymentNotify(returnPayment);

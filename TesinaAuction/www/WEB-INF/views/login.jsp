...
<div class="item-wrap">
	<div class="item-html">
		<input id="tab-1" type="radio" name="tab" class="item-insert" checked><label for="tab-1" class="tab">Login</label>
		<!-- <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">REGISTRATI</label> -->
		<div class="insert-item-form">
<form:form class="insert-in-html" method="post" modelAttribute="staff" action="${pageContext.request.contextPath}/staff/login">

	<div class="group">
	<form:input class="input" path="email" value="${ datiLogin.email }" required="required" placeholder="Email"/>
	</div>
	<br/>
	<div class="group">
	<form:input class="input" type="password" path="password" value="${ datiLogin.password }" required="required" placeholder="Password"/>
	</div>
	<br/>
	<div class="group">
...
.item-wrap {
  ...
  min-height: 450px;
  position: relative;
  background: url(https://png.pngtree.com/png-vector/20190623/ourlarge/pngtree-hammer-judge-icon-png-image_1511242.jpg);
...
.item-html .item-insert,
.insert-item-form .group .check {
  display: none;
}
...
.item-html .item-insert:checked+.tab,
.item-html .sign-up:checked+.tab {
  color: #fff;
  border-color: #1161ee;
}
